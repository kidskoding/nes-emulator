mod test_ldx {
    ...
    fn test_ldx_zero_page() {
        ...
        cpu.load_and_run(vec![0xA6, 0x10, 0x00]).unwrap();
    ...
    fn test_ldx_zero_page_y() {
        ...
        cpu.load_and_run(vec![0xB6, 0x10, 0x00]).unwrap();
    ...
    fn test_ldx_absolute() {
        ...
        cpu.load_and_run(vec![0xAE, 0x34, 0x12, 0x00]).unwrap();
    ...
    fn test_ldx_absolute_y() {
        ...
        cpu.load_and_run(vec![0xBE, 0x34, 0x12, 0x00]).unwrap();
        assert_eq!(cpu.register_x, 0x8A);
    }
    ...
    fn test_ldx_sets_negative_flag() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![0xA2, 0x80, 0x00]).unwrap();
